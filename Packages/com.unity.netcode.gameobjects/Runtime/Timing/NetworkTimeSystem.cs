...
namespace Unity.Netcode
{
    ...
    public class NetworkTimeSystem
    {
        ...
        // Shutdown occurs after the connection manager has reset its client
        // state. Keep our own subscription state instead of reading that
        // disposed dependency a second time during OnDestroy/ApplicationQuit.
        private bool m_TimeSyncSubscribed;
        ...
        {
            if (m_TimeSyncSubscribed && m_NetworkTickSystem != null)
            {
                m_NetworkTickSystem.Tick -= OnTickSyncTime;
            }

            m_TimeSyncSubscribed = false;
        }
