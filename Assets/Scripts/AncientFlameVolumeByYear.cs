...
// Cible d'affichage: change le Volume profile depuis AncientFlameDisplayManager.
[DisallowMultipleComponent]
public class AncientFlameVolumeByYear : MonoBehaviour, IAncientFlameDisplayTarget
{
    [Serializable]
