	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( ( tex2D( _MainTex, uv_MainTex ) * ( 1.0 - tex2DNode16.a ) ) + ( tex2DNode16 * float4( 0,0,0,0 ) ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_OverlayTex = packedInput.ase_texcoord2.xy * _OverlayTex_ST.xy + _OverlayTex_ST.zw;
				float4 tex2DNode16 = tex2D( _OverlayTex, uv_OverlayTex );
...
ASEEND*/
//CHKSM=4BEFEAEDAE684CAC22ECD821C9E5CE0A82BC9497